...
public class StepDownTest : FSMTestBase {
    ...
    public void StepDownTest1() {
        ...
        fsm.Step(Id2,
            new AppendResponse {
                CurrentTerm = fsm.CurrentTerm, CommitIdx = 0, Accepted = new AppendAccepted { LastNewIdx = idx }
            });
        Assert.That(fsm.IsLeader, Is.True);
        ...
        fsm.Step(Id2,
            new AppendResponse {
                CurrentTerm = fsm.CurrentTerm, CommitIdx = idx, Accepted = new AppendAccepted { LastNewIdx = idx }
            });
        ...
        // Turn to a leader
        fsm2.Step(Id2, new VoteResponse { CurrentTerm = fsm2.CurrentTerm, VoteGranted = true });
        ...
        fsm2.Step(Id2,
            new AppendResponse {
                CurrentTerm = fsm2.CurrentTerm, CommitIdx = idx, Accepted = new AppendAccepted { LastNewIdx = idx }
            });
